...
Page({
  ...
  modify(e) {
    ...
    wx.navigateTo({
      url: './zhoucaiplay-up/zhoucaiplay-up?id=' + e.currentTarget.dataset.item.materialsPlanId,
    })
    wx.hideLoading()
  },
  tapDialogButton(e) {
  ...
  approval(e) {
    this.setData({
      ...
      duang: 'approval',
      dialogShow: true,
      id: e.currentTarget.dataset.item.materialsPlanId
    })
  },
  //审核
  examine(e) {
  ...
  load() {
    wx.request({
      url: this.data.baseUrl + 'terminal/bussMaterialsPlanListAppProject.do?',
      data: {
        tmessage: { 
          "query": { 
  ...
  equipmentdelt(e) {
    ...
    wx.navigateTo({
      url: './zhoucaiplaydelt/zhoucaiplaydelt?id=' + e.currentTarget.dataset.id,
    })
    wx.hideLoading()
  },
  /**
  ...
  increase() {
    wx.navigateTo({
      url: './add-zhoucaiplay/add-zhoucaiplay',
    })
  }
})