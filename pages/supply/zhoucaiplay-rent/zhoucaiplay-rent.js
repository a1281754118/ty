...
Page({
  ...
  data: {
    ...
    pageSize: '15',//显示条数
    url: 'terminal/bussEquipRentListAppProject.do?',
    qingqiu: true,
    buttons: [{
      text: '驳回'
    }, {
  ...
  modify(e) {
    ...
    wx.navigateTo({
      url: './zhoucaiplay-rent-up/zhoucaiplay-rent-up?id=' + e.currentTarget.dataset.item.materialsRentId,
    })
    wx.hideLoading()
  },
  tapDialogButton(e) {
  ...
  approval(e) {
    this.setData({
      ...
      duang: 'approval',
      dialogShow: true,
      id: e.currentTarget.dataset.item.materialsRentId
    })
  },
  //审核
  examine(e) {
  ...
  equipmentdelt(e) {
    ...
    wx.navigateTo({
      url: './zhoucaiplay-rent-list/zhoucaiplay-rent-list?id=' + e.currentTarget.dataset.id,
    })
    wx.hideLoading()
  },
  /**
  ...
  increase() {
    wx.navigateTo({
      url: './add-zhoucaiplay-rent/add-zhoucaiplay-rent',
    })
  }
})