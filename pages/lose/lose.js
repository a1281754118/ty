Page({
  ...
  data: {
    ...
    adTitle: '', //搜索内容
    display: 'none',
    url: 'terminal/bussLostCompenListAppProject.do?', //
  ...
  detailed(e) {
    ...
    wx.navigateTo({
      url: './lose detailed/lose detailed?id=' + id
    })
  ...
  camera() {
    ...
    const load = (e) => {
      ...
      wx.navigateTo({
        url: './lose detailed/lose detailed?arr=' + JSON.stringify(e) + '&display=' + 'block' + '&relateId=' + this.data.relateId
      })
    };
